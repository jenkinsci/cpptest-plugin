...
public class CpptestParser extends AbstractAnnotationParser {
    ...
    public Collection<FileAnnotation> parse(final InputStream file, final String moduleName) throws InvocationTargetException {
        try {
            ...
            String fileFlowXPath = "ResultsSession/CodingStandards/StdViols/FlowViol";
            digester.addObjectCreate(fileFlowXPath, hudson.plugins.cpptest.parser.StdViol.class);
            digester.addSetProperties(fileFlowXPath);
            digester.addSetNext(fileFlowXPath, "addFile", hudson.plugins.cpptest.parser.StdViol.class.getName());
