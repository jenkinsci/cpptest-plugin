...
/**
 * Java Bean class representing a Cpptest rule.
 *
 * @author NQH
 */
public class Rule {
    /** Description to indicate that the rules stored in this plug-in don't match with the generators version. */
    static final String UNDEFINED_DESCRIPTION = "No description available. Please upgrade to latest Cpptest version.";
